...
import { symRoundedDownload } from '@quasar/extras/material-symbols-rounded';
...
const saveImage = () => {
  const linkSource = areaChart.value.getDataURL();
  const downloadLink = document.createElement('a');
  document.body.appendChild(downloadLink);
  downloadLink.href = linkSource;
  downloadLink.target = '_self';
  downloadLink.download = 'StackedAreaChart.png';
  downloadLink.click();
};
